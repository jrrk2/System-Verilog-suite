...
\url{https://github.com/jrrk2/System-Verilog-suite}.
...
\begin{lstlisting}[language=bash]
git clone https://github.com/jrrk2/System-Verilog-suite.git
cd System-Verilog-suite
eval $(opam env --switch=5.3.0 --set-switch)
dune build @all
\end{lstlisting}
...
env USE_DECOMP_SYNTH=1 \
    DECOMP_SHIM=$HOME/System-Verilog-suite/_build/default/mac_synth_shim.exe \
