print("== routing-completeness check (clean P&R netlist) ==")
print("route_check: " .. svd.route_check("/Users/jonathan/nextpnr-xilinx/xilinx/examples/counter25/routed.json"))
